...
Search `ui.` in the [Config reference](/docs/config-reference/) for Space sidebar sizing, collapsed mode, mouse behavior, pane borders, and other presentation settings.
