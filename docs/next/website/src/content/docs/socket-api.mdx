...
worktree discovery remains `worktree.list`. Legacy multi-tab snapshots continue
to restore and enumerate; clients must not rely on desktop management or
switching of their non-active tabs.
